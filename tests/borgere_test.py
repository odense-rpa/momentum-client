...
def test_hent_borger(momentum_manager: MomentumClientManager):
    # Test with a valid TEST CPR number
    response = momentum_manager.borgere.hent_borger("")  # TODO: Replace with actual test CPR
...
def test_opret_markering(momentum_manager: MomentumClientManager):
    # Test opret_markering med en gyldig markering
    markeringsnavn = "Teknisk forlængelse - sygedagpenge"
    # IKKE COMMIT CPR-nummer i test
    borger = momentum_manager.borgere.hent_borger("")  # TODO: Replace with actual test CPR
...
def test_afslut_markering(momentum_manager: MomentumClientManager):
    # IKKE COMMIT CPR-nummer i test
    borger = momentum_manager.borgere.hent_borger("")  # TODO: Replace with actual test CPR
...
def test_opret_notifikation(momentum_manager: MomentumClientManager):
    # IKKE COMMIT CPR-nummer i test
    borger = momentum_manager.borgere.hent_borger("1001979215")  # TODO: Replace with actual test CPR
    start_dato = datetime.date.today()
